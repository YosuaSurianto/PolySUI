      ...
      <section className="hero-final">
        <div className="container">
          <div className="hero-content-center">
            ...
            <h1 className="hero-title-final">Decentralized Betting Platform</h1>

            <p className="hero-subtitle-final">
              Create transparent, immutable betting markets on the blockchain.
              One bet per user, fully on-chain.
            </p>
        ...
        <div className="container">
          ...
          <div className="features-grid-final">
            ...
            <div className="feature-box-final">
              ...
              <p>
                Instant bet recording with minimal transaction fees on Sui
                network
              </p>
            </div>
            ...
            <div className="feature-box-final">
              ...
              <p>
                One bet per wallet address with publicly verifiable results
              </p>
            </div>
        ...
        <div className="container">
          ...
          <div className="use-cases-grid-final">
            <div className="use-case-box-final">
              ...
              <p>
                Let your community bet on proposals, feature requests, and
                project direction
              </p>
            </div>
            ...
            <div className="use-case-box-final">
              ...
              <p>
                Organize events democratically by betting on venues, dates,
        ...
        <div className="container">
          ...
          <div className="steps-grid-final">
            ...
            <div className="step-box-final">
              ...
              <p>
                Monitor bets in real-time with transparent, immutable counting
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="cta-final">
        <div className="container">
          <div className="cta-content-final">
            ...
            <p>Create your first betting market in under a minute</p>
